                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div id="example1_filter" class="dataTables_filter">
                                <form method="GET" action="{{route('Ad.All')}}">
                        ...
                        <div class="col-sm-12">
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid"
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="لینک: activate to sort column ascending">لینک
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td><img src="{{$ad->Image}}" width="50" height="50"></td>
                                    <td>
                                        <a href="{{route('Ad.Edit' , $ad->id)}}">ویرایش</a> |
                                        <a href="{{route('Ad.Delete' , $ad->id)}}">حذف</a>
